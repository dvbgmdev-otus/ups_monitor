...
| Параметр | Критерий нормы | Критичный | Бит в маске отклонений | Имя флага |
|---|---|---:|---:|---|
...
| `WARNING` | Получен хотя бы один SNMP-ответ, а значение некритичного параметра не получено, невозможно проверить или оно находится вне нормы; выходное напряжение находится в допустимом диапазоне. |
| `FAILURE` | Получен хотя бы один SNMP-ответ, а значение выходного напряжения не получено, невозможно проверить или оно находится вне нормы. |
